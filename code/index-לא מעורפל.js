...
let objMedInfo = {
    ...
    "Penicillin-G": {
       ...
       contraindication : "אלרגיה לתרופה.",
        ...
        patientGuidelines : "<ol class=list><li>לא להפסיק את הטיפול באמצע, אלא לסיים את כולו, גם אם מרגישים טוב יותר.</li><li>מומלץ לקחת אחרי אוכל, על בטן מלאה (כדי להפחית תופעות לוואי במערכת העיכול).</li><li>לפנות לבדיקה רפואית במקרה של שלשול ממושך (גם בשבועות שאחרי סיום הטיפול) – עלול להעיד על זיהום מסויים במעי הגס הדורש טיפול (CDAD).</li><li>לפנות לבדיקה רפואית אם מופיעה תגובה אלרגית, גם תגובה אלרגית קלה כמו פריחה.</li><li>להימנע משימוש בזמן מחלת הנשיקה</li></ol>",
    ...
    "Cephalexin": {
        ...
        contraindication : "אלרגיה לתרופה.",
        sideEffect : "נפוצות:<br><ol class=list><li>כאבי בטן.</li><li>פריחה.</li></ol>",
    ...
    "Cefuroxime": {
        ...
        contraindication : "אלרגיה לתרופה.",
        sideEffect : "נפוצות:<br><ol class=list><li>כאבי בטן.</li><li>פריחה.</li></ol>",
        patientGuidelines : "<ol class=list><li>לא להפסיק את הטיפול באמצע, אלא לסיים את כולו, גם אם מרגישים טוב יותר.</li><li>מומלץ לקחת אחרי אוכל, על בטן מלאה (כדי להפחית תופעות לוואי במערכת העיכול).</li><li>לפנות לבדיקה רפואית במקרה של שלשול ממושך (גם בשבועות שאחרי סיום הטיפול) – עלול להעיד על זיהום מסויים במעי הגס הדורש טיפול (CDAD).</li><li>לפנות לבדיקה רפואית אם מופיעה תגובה אלרגית, גם תגובה אלרגית קלה כמו פריחה.</li><li>יש לשים לב להתפתחות תופעת לוואי של סחרחורת ולא לנהוג תחת השפעת התרופה עד וידוא כי אין סחרחורת משמעותית.</li></ol>",
        mechanismOfAction : "פגיעה בבניית דופן התא של החיידקים ועל כן הריגה של החיידקים.",
    },
    "Macrolides": {
        medType: "antibiotics",
        ...
        commercialName : "Klarin, Klaridex.<br>Rulid.<br>Acnetrim, Acnemycin.",
