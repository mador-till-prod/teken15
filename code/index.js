...
let objMedInfo = {
    ...
    "Paracetamol-Orphenadrine": {
        ...
        contraindication : "<ol class=list><li>אלרגיה לתרופה .</li><li>בעיה בתפקודי כבד.</li><li>גלאוקומה.</li><li>מחלה בוושט.</li><li>חסימת מעי.</li><li>חסימת דרכי השתן.</li><li>חולשת שרירים חמודה.</li><li>בלוטת ערמונית מוגדלת.</li></ol>",
        sideEffect : "יובש בפה.",
